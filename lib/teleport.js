...
(function(global) {
    ...
    */
    ...
    require.Sandbox = function Sandbox(properties) {
        var descriptors = __descriptors__, dependencies = __dependencies__;
        
        var require = function require(id) {
            var descriptor = descriptors[id];
            if (undefined === descriptor.module) descriptor.factory.call({}, require, 
                descriptor.module = {}, descriptor.meta = { id: id }, global)
        ...
        function main(id) {
            ...
            var module = {};
            var descriptor = descriptors[id] = { module: module };
            require.ensure(dependencies, function(require) {
                require.main = descriptor.meta = { id: id };
                require(id);
            });
            return modules;
        };
        ...
        "transquire/loader": function (require, exports, module, global) {
            ...
            */
            ...
            var Require = exports.Require = function Require(baseId) {
                ...
                */
                requirer.ensure = function ensure(identifiers, callback) { 
                    preload(identifiers, callback, baseId);
                }
            ...
            var load = exports.load = function load(id, require, reload) {
