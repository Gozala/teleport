...
(function(global) {
    ...
    var require = global.require = function preRequire(id) { // wiil be replaced by require.Sandbox
        return (global.require = require.Sandbox())(id);
    };
    require.main = function preMain(id) { // wiil be replaced by require.Sandbox
        return (global.require = require.Sandbox()).main(id);
    };
    require.ensure = function preEnsure(modules, callback) {
        return (global.require = require.Sandbox()).ensure(modules, callback);
    };
    /**
    ...
    */
    var define = require.define = function define(factories, dependencies, extra) {
        var descriptors = __descriptors__;
        ...
        if (undefined !== dependencies && 0 < dependencies.length) depends.push.apply(depends, dependencies);
    };
    var __descriptors__ = {}, __dependencies__ = [];
    require.Sandbox = function Sandbox(properties) {
        var descriptors = __descriptors__, dependencies = __dependencies__, MainMeta = {};
        var require = function require(id) {
            var descriptor = descriptors[id];
            if (true !== descriptor.loaded) descriptor.factory.call({}, require, descriptor.module, descriptor.meta, global);
            return descriptor.module;
        };
        function main(id) {
            require.main = MainMeta;
            var system = require("system");
            if (properties.override) id = system.env.main || id;
            else id = id || system.env.main;
            if (!id) {
                require.main = main;
                throw new Error("Main module is not specified");
            }
            dependencies.push(id);
            var module = {};
            var descriptor = descriptors[id] = { module: module, meta: MainMeta };
        ...
        return require = require("transquire/loader").Require();
    };
    ...
    require.define(/* Implementation of CommonJS stdlib. */{
        ...
        */
        "system": function system(require, exports, module, global) {
            var ENGINE = require("transquire/engine");
            function Stream() {
                var buffer = [];
                var stream = {
                    write: function(text) {
        ...
        /**
            ...
            @module
        */
        "console": function console(require, exports, module) {
            ...
            function Dump(stream, prefix, suffix) {
                ...
                return function dump() {
                    var message = map(arguments, function(argument) {
        ...
        "narwhal/promise": function(require, exports, module, global) {
            ...
            if (typeof setTimeout === "function") {
                ...
                throw new Error("no setTimeout found")
            }
            ...
            function Promise(descriptor, fallback) {
                ...
                promise.emit = function emit(op, resolved /* ...args */) {
                ...
                promise.toSource = promise.toString = function toString() {
                    return '[object Promise]';
                };

                promise.valueOf = function valueOf() {
        ...
        "transquire/packages": function(require, exports, module, global) {
            ...
            exports.descriptors = __descriptors__;
        },
        "transquire/loader": function (require, exports, module, global) {
            var PACKAGES = require("transquire/packages"), catalog = PACKAGES.catalog,
            ...
            */
            ...
            function ensure(identifiers, callback) {
            ...
            function Descriptor(id, baseId, descriptors) {
                ...
                var descriptor = descriptors[id];
                if (undefined !== descriptor && true === descriptor.sync) return descriptor;
                var result = Deferred();
                var url = path(id);
                ...
                request.onreadystatechange = function onreadystatechange() {
                    if (request.readyState == 4) {
                        if ((request.status == 200 || request.status == 0) && request.responseText != "") {
                            var dependencies = descriptor.dependencies = dependencies(source);
                            descriptor.source = Wrap(source, id, url);
                            descriptor.sync = true;
                            result.resolve(0 === dependencies.length ? value : all(Descriptors(dependencies, baseId, descriptors), value));
                        } else {
                            result.resolve(Rejection(descriptor));
                        }
                    }
                };
                request.send(null);
            ...
            var load = exports.load = function load(id) {
                ...
                var descriptor = descriptors[id];
                if (undefined === descriptor || true !== descriptor.sync) {
                    ensure([id], function() { load(id) });
                } else { // module is fetched
                    var factory = descriptor.factory, source = descriptor.source;
                    try {
                        try {
                            if (undefined === factory && undefined !== source) {
                        ...
                        if (undefined !== factory && true !== descriptor.loaded) {
                            // module factory is here but module is not created yet
                            factory.call({}, Require(id), descriptor.module, descriptor.meta, global);
            ...
            function exception(e, id, line) {
                ...
                if (!uri) {
                    for (var key in descriptors) {
                        ...
                        if (undefined !== descriptor.extra && descriptor.extra.sourceId == this.sourceId) {
                            uri = path(id = key)
                            break;
                        }
                    }
                ...
                var descriptor = descriptors[id];
                var factory = descriptor.source || descriptor.factory;
                // error details
...
require.define({
    "transquire/engine": function(require, exports, module, global) {
